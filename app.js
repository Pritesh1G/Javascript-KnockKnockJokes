var jokes = [
    ...
    { name: 'Wanda', answer: 'Wanda hang out with me right now?' },
    ...
    { name: 'Irish', answer: 'Irish you a Merry Christmas!' },
    { name: 'Carmen', answer: 'Carmen let me in already!' },
    { name: 'Ya', answer: 'I’m excited to see you too!' },
    { name: 'Scold', answer: 'Scold outside—let me in!' },
    { name: 'Robin', answer: 'Robin you! Hand over your cash!' },
    { name: 'Irish', answer: 'Irish you a Merry Christmas!' },
    { name: 'Otto', answer: 'Otto know what’s taking you so long!' },
    { name: 'Needle', answer: 'Needle little help gettin’ in the door.' },
    { name: 'Luke', answer: 'Luke through the keyhole to see!' },
    { name: 'Justin', answer: 'Justin the neighborhood and thought I’d come over.' },
    { name: 'Europe', answer: 'No, you are a poo' },
    { name: 'To', answer: 'To Whom.' },
    { name: 'Etch', answer: 'Bless You!' },
    { name: 'Mikey', answer: 'Mikey doesnt fit through this keyhole' },
]
